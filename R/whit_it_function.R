################################################################################
#' Obtain whittaker biomes for sites based on their MAT and MAP
#'
...
#'
#' @param data Data frame with at least a column for MAT and a column for MAP.
...
whit_it <- function(data, mat, map) {
  #Create biome boundaries
  ...
  # Convert biomes to SpatialPolygonsDataFrame object
